...
public final class PlaybackTestDatabase {
    private PlaybackTestDatabase() {
    }
    ...
    public static Feed storeFeed(Context context, String url, String title, int numItems) {
        ...
        for (int i = 0; i < numItems; i++) {
            FeedItem item = new FeedItem(0, title + " Episode " + i, url + "/id" + i, "link",
    ...
    public static FeedItem storedItem(long feedId, String identifier) {
