package de.danoeh.antennapod.net.sync.testsupport;
...
public class FakeHttpClient {
    ...
    private Runnable beforeEachReply = () -> { };
    ...
    public FakeHttpClient beforeEachReply(Runnable action) {
        beforeEachReply = action;
        return this;
    }
